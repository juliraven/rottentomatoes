...
st.markdown('<span style="font-size: 24px">Strona ta poświęcona jest analizie zbioru zawierającego recenzje filmów napisane przez krytyków na stronie Rotten Tomatoes. Znajdują się tutaj wizualizacje informacji zawartych w tym zbiorze, a także oceny moddeli zbudowanych w oparciu o dane się w nim znajdujące.</span>', unsafe_allow_html=True)
