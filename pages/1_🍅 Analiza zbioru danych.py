...
if selected == "Wykresy":
    ...
    min_value=df['original_release_date'].dt.year.min(),
    max_value=df['original_release_date'].dt.year.max(),
    value=(df['original_release_date'].dt.year.min(), df['original_release_date'].dt.year.max())
    )
